...
function.add_argument(
    ...
    help="The name of the function to allow / deny access.")

user_id = ArgumentParser(add_help=False)
user_id.add_argument(
    "user_id", type=int, nargs="+",
    help="A list of integer user ids.")

# main admin control parser
parser = ArgumentParser(
    prog="admin", description="Telegram bot admin.",
